...
<div class="prod-slider">
    <div class="slider-header">
        ...
        <div class="action">
        <button aria-label="Previous" class="glider-prev act-but" style = ".slider:active{padding: 20px}"><i class="fa-solid fa-chevron-left"></i></button>
        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                $s ="";
                $s.='<div class="slider" id="<?php echo $div_id; ?>">';
...
<script type="text/javascript">
		window.onload = function() {
			var div = document.getElementById("<?php echo $div_id; ?>");
